        ...
        <div className={styles.col}>
          <div className={styles.video_wrapper}>
            <iframe
              width="400"
              height="200"
              src="https://www.youtube.com/embed/UHo3M6b3k2o"
          ...
          <div className={styles.details_wrapper}>
            ...
            <div className={styles.stats_wrapper}>
              ...
              <div className={styles.btns_wrapper}>
                <div className={styles.btn_wrapper}>
                  ...
                  <p className={styles.btn_text}>{props.likes}</p>
                </div>
                <div className={styles.btn_wrapper}>
                  <ThumbUpAltIcon className={styles.action_btn} />
            ...
            <div className={styles.comments}>
              {SampleComments.filter((data) => data.postId == props.id).map(
                (filteredComments) => (
                  <Comment
                    data={filteredComments}
                    key={filteredComments.commentId}
                  />
                )
              )}
            </div>
